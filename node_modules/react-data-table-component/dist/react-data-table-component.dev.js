...
var TableFooter = styled__default.nav(_templateObject$2(), function (props) {
...
var CellBase = styled__default.div(_templateObject$4(), function (props) {
...
var Cell = styled__default(CellBase)(_templateObject2$1(), function (props) {
  return props.column.grow === 0 ? 0 : props.column.grow || 1;
}, function (props) {
  return props.column.maxWidth || '100%';
}, function (props) {
  return props.column.minWidth || '100px';
}, function (props) {
  return props.column.width && styled.css(_templateObject3(), props.column.width, props.column.width);
}, function (props) {
  ...
  return !props.internalCell && styled.css(_templateObject4(), props.theme.cells.cellPadding);
}, function (props) {
  return props.theme.cells.cellPadding;
}, function (props) {
  return props.column.button && styled.css(_templateObject5(), props.theme.cells.cellPadding);
});
...
var TableRowStyle = styled__default.div(_templateObject6(), function (props) {
...
function (_Component) {
  ...
  function DataTable(props) {
    ...
    _this.sortedRows = index(function (rows, defaultSortField, direction) {
      return orderBy_1(rows, defaultSortField, direction);
    });
